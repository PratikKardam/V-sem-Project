...
const Hero = () => {
  return (
    <>
      ...
      <div className='context'>We take the time to get to know each of our members and bus partners. We check reviews, profiles and IDs, so you know who you’re travelling with and can book your ride at ease on our secure platform.</div>
      </div>
      ...
      <div className='context'>Booking a ride has never been easier! Thanks to our simple app powered by great technology, you can book a ride close to you in just minutes.</div>
      </div>
      </div>
      ...
      <div className="max-w-sm w-96 lg:max-w-full lg:flex flex-col m-28">
        ...
        <Link to="/ride" className='bg-[#00a8e9] p-3 max-w-max text-white rounded-2xl'>Offer a drive</Link>
      </div>
    </>
  )
}
